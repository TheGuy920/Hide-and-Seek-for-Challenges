...
function ChallengeVictoryWorld.client_onUpdate( self, dt )
	...
	local cutscene = _G.g_effectManager:cl_getWorldNamedEffect( self, "cinematic.challengemodecomplete" )
	if cutscene then
...
function ChallengeVictoryWorld.cl_n_spawned( self )
	if self.cl.watchedCutscene then
		...
		_G.g_effectManager:cl_playNamedCinematic( "cinematic.challengemodecomplete", callbacks )
	end
end
